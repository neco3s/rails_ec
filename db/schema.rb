...
ActiveRecord::Schema[7.0].define(version: 2023_07_18_003422) do
  ...
  create_table "cart_transactions", force: :cascade do |t|
    ...
    t.index ["product_id"], name: "index_cart_transactions_on_product_id"
  end
  ...
  add_foreign_key "cart_transactions", "products"
end
